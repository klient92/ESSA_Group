...
namespace MessageBus
{
    ...
    public class SubscriptionRegistry
    {
        ...
        {
            //System.Diagnostics.Debug.Write(String.Format("pTopic:{0} HandlerAddress:{1}",pTopic, pHandlerAddress));
            //pTopic:Silver 
            //HandlerAddress:net.msmq://localhost/private/TrendViewerTransacted
